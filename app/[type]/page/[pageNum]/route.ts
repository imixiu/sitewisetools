...
export async function GET(_request: Request, { params }: { params: Promise<{ type: string; pageNum: string }> }) {
  const { type: _rawType, pageNum } = await params;
